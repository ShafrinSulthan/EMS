            ...
            <h3 className="text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100">Employment Details </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <input type="number" name="allowances" min="0" step="0.01" required defaultValue={initialData?.allowances || 0 }></input>
                    </div>
                    <div>
                        <label className="block mb-2">Deductions</label>
                        <input type="number" name="deductions" min="0" step="0.01" required defaultValue={initialData?.deductions || 0 }></input>
                    </div>
                    {isEditMode && (
                            <div>
                                <label className="block mb-2">Status</label>
                                <select name="employeeStatus" required defaultValue={initialData?.employeeStatus ||"ACTIVE"}>
        ...
        <div className="card p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                ...
                <div>
                    ...
                    <input type="email" name="personalEmail" defaultValue={initialData?.personalEmail || ""}></input>
                </div>
                {!isEditMode && (
                    <div>
