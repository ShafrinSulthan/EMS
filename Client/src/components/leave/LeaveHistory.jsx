...
import { Badge, Check, Loader2, X } from 'lucide-react'
                            ...
                            leaves.map((leave) => {
                                ...
                                return (
                                    <tr key={leave._id || leave.id}>
                                        ...
                                        <td>
                                            <span className='badg bg-slate-100 text-slate-600'>{leave.type}</span>
                                        </td>
                                            ...
                                            <td>
                                                {leave.status === 'PENDING' && (
                                                    <div className='flex justify-center gap-2'>
                                                        ...
                                                        disabled={!!processing}
                                                        className='p-1.5 rounded-md bg-emerals-50 text-emerald-600 hover:bg-emerald-100 transiltion-colors'>
                                                        ...
                                                        disabled={!!processing}
                                                        className='p-1.5 rounded-md bg-rose-50 text-rose-600 hover:bg-rose-100 transiltion-colors'>
